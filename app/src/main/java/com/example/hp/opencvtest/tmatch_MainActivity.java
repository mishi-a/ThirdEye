 ...
 */
public class tmatch_MainActivity extends Activity implements CvCameraViewListener2 {
    /**
     ...
     */
    private static final int TEMPLATE_IMAGE = R.drawable.cards;
    /**
     * the result matrix
     */
    Mat result;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tmatch_activity_main);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        result = new Mat(new Size(result_rows, result_cols), CvType.CV_32FC1);
